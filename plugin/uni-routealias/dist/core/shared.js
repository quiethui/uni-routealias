...
export function splitRouteUrl(url) {
    const normalizedUrl = String(url !== null && url !== void 0 ? url : "");
...
export function joinRouteUrl(path, query = "", hash = "") {
...
export function isExternalUrl(url) {
    return EXTERNAL_URL_RE.test(String(url !== null && url !== void 0 ? url : "").trim());
}
export function getDefaultAliasPath(actualPath) {
...
export function toRouteMetaPath(path) {
